...
public class DefaultConcertusersService implements ConcertusersService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultConcertusersService.class);
	...
	{
		return DefaultConcertusersService.class.getResourceAsStream("/concertusers/sap-hybris-platform.png");
	}
