...
public class DefaultConcertticketsService implements ConcertticketsService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultConcertticketsService.class);
	...
	{
		return DefaultConcertticketsService.class.getResourceAsStream("/concerttickets/sap-hybris-platform.png");
	}
